...
The project is aimed to study patient retention patterns and build predictive models to identify patients at risk of leaving a healthcare provider.
...
# PROJECT FINDINGS
After model training, the best perfoming model was Logistic regression

The model was saved for launch in a user-friendly interface
